...
export default function Topbar() {
  ...
  return (
    <header className="h-16 bg-linear-to-r from-gray-900/80 to-gray-800/60 border-b border-gray-700/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-50">
      {/* Left side */}
